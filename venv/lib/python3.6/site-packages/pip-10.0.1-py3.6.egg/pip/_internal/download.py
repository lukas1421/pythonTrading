...
def get_file_content(url, comes_from=None, session=None):
    ...
    :param session:     Instance of pip.download.py.PipSession.
    """
    if session is None:
        raise TypeError(
...
def unpack_http_url(link, location, download_dir=None,
    ...
    with TempDirectory(kind="unpack") as temp_dir:
        # If a download.py dir is specified, is the file already downloaded there?
        ...
        if already_downloaded_path:
            ...
            # let's download.py to a tmp dir
        ...
        # a download.py dir is specified; let's copy the archive there
...
def unpack_file_url(link, location, download_dir=None, hashes=None):
    ...
    # If a download.py dir is specified, is the file already there and valid?
    already_downloaded_path = None
    if download_dir:
        already_downloaded_path = _check_download_dir(link,
                                                      download_dir,
    ...
    # a download.py dir is specified and not already downloaded
    if download_dir and not already_downloaded_path:
        _copy_file(from_path, download_dir, link)
